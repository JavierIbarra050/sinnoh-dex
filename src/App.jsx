          ...
          <div className="controls">
            ...
            <div className="buttons">
              <button className={`action-button button-b ${version === 'pearl' ? 'active' : ''}`} onClick={() => setVersion('pearl')} title="Shining Pearl">
                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-viii/icons/484.png" alt="Palkia" style={{width: '50px', height: '50px', transform: 'scale(1.6) translateY(-3px)'}} />
              </button>
              <button className={`action-button button-a ${version === 'diamond' ? 'active' : ''}`} onClick={() => setVersion('diamond')} title="Brilliant Diamond">
                <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-viii/icons/483.png" alt="Dialga" style={{width: '50px', height: '50px', transform: 'scale(1.6) translateY(-3px)'}} />
              </button>
            </div>
          </div>
        </div>
